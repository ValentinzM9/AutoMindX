...
public class VentanaPrincipal extends JFrame {
    ...
    public VentanaPrincipal(ControladorAutomata controladorDFA,
    ...
    private JPanel crearBarraInferior() {
        ...
        botonLimpiar.addActionListener(e -> limpiarAreas());
    ...
    private void mostrarModoDFA() {
        ...
        JScrollPane editor = new JScrollPane(panelAutomata);
